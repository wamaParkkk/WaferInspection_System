...
{
    public partial class AlignerForm : UserControl
    {
        ...
        public AlignerForm(MaintnanceForm parent)
        {
            m_Parent = parent;

            module = (int)MODULE._Aligner;
            ModuleName = "Aligner";

            InitializeComponent();            
        }

        private void AlignerForm_Load(object sender, EventArgs e)
        {
            Width = 1172;
            Height = 824;
            Top = 0;
        ...
        {
            if (Define.bAlignerEvent)
            {
                Eventlog_File_Read();
            }

            if (Define.bAlignerAlmEvent)
            {
                Alarmlog_File_Read();
            }
        }
        ...
        private void Digital_Click(object sender, EventArgs e)
        {
            ...
            switch (strTmp)
            {
                case "0":
                    {
                        digitalDlg.Init("Close", "Open", "Aligner Cover Door");
